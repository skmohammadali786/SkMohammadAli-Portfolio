  ...
  experience: [
    {
      ...
      description: "Taking on leadership roles in various academic and extracurricular projects."
    },
    {
      role: "Project Management",
      company: "Various",
      period: "Nov 2024 - Present",
      description: "Overseeing project lifecycles and ensuring successful delivery of technical tasks."
    },
    {
      role: "Event Management",
      company: "Various",
      period: "May 2025 - Present",
      description: "Organizing and coordinating engineering and social events."
    }
  ],
  education: [
    {
